...
final class MetreMetricsView {
    ...
    private ViewSnapshot current() {
        ...
        synchronized (this) {
            ...
            Metre.MetricsSnapshot refreshed = engine.metrics();
    ...
    private static final class ViewSnapshot {
        ...
        static ViewSnapshot from(Metre instance, Metre.MetricsSnapshot metrics) {
            Metre.MetricsSnapshot snapshot = metrics != null ? metrics : Metre.MetricsSnapshot.empty();
            return new ViewSnapshot(
                snapshot.evalCount,
