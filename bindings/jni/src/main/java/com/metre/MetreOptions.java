...
public final class MetreOptions {
    final MqttOptions mqtt = new MqttOptions();
    final FfiOptions ffi = new FfiOptions();
    final JvmOptions jvm = new JvmOptions();

    public MetreOptions mqtt(Consumer<MqttOptions> configurer) {
        configurer.accept(mqtt);
        return this;
    }

    public MetreOptions ffi(Consumer<FfiOptions> configurer) {
        configurer.accept(ffi);
        return this;
    }

    public MetreOptions jvm(Consumer<JvmOptions> configurer) {
    ...
    public static final class FfiOptions {
        String ruleJsonPath;
        int payloadFormat = Metre.PAYLOAD_JSON;
