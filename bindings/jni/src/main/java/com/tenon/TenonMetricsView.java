...
final class TenonMetricsView {
    ...
    private ViewSnapshot current() {
        ...
        synchronized (this) {
            ...
            Tenon.MetricsSnapshot refreshed = engine.metrics();
    ...
    private static final class ViewSnapshot {
        ...
        static ViewSnapshot from(Tenon instance, Tenon.MetricsSnapshot metrics) {
            Tenon.MetricsSnapshot snapshot = metrics != null ? metrics : Tenon.MetricsSnapshot.empty();
            return new ViewSnapshot(
                snapshot.evalCount,
