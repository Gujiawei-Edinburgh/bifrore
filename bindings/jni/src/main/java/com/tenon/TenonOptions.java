...
public final class TenonOptions {
    final MqttOptions mqtt = new MqttOptions();
    final FfiOptions ffi = new FfiOptions();
    final JvmOptions jvm = new JvmOptions();

    public TenonOptions mqtt(Consumer<MqttOptions> configurer) {
        configurer.accept(mqtt);
        return this;
    }

    public TenonOptions ffi(Consumer<FfiOptions> configurer) {
        configurer.accept(ffi);
        return this;
    }

    public TenonOptions jvm(Consumer<JvmOptions> configurer) {
    ...
    public static final class FfiOptions {
        String ruleJsonPath;
        int payloadFormat = Tenon.PAYLOAD_JSON;
